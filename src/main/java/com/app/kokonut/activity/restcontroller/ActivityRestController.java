package com.app.kokonut.activity.restcontroller;
...
//    }
    ...
    public ResponseEntity<Map<String,Object>> activityManagement(@RequestParam(name="type") Integer type){
        ...
        List<ActivityDto> activityDtoList = activityService.findByActivityTypeList(type);
        log.info("activityDtoList : "+activityDtoList);

        data.put("activityDtoList",activityDtoList);
