...
public class CollectInformationRestController {
    ...
    @ApiOperation(value="CollectInfo 목록 조회", notes="개인정보 수집 및 이용 안내 목록 조회")
    ...
    @ApiOperation(value="CollectInfo 내용 조회", notes="개인정보 수집 및 이용 안내 내용 조회")
    ...
    @ApiOperation(value="CollectInfo 등록, 수정", notes="개인정보 수집 및 이용 안내 수정, 등록")
    ...
    @ApiOperation(value="CollectInfo 삭제", notes="개인정보 수집 및 이용 안내 삭제")
